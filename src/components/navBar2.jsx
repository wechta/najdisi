...
const cx = classPrefixer('navbar2');
...
export default class NavBar extends React.PureComponent {
    ...
    render() {
        ...
        console.log(initial, topItems, moreItems);
        /* eslint-disable */
        return (
                ...
                <If condition={initial}>
                    <div className="nav">
                      <ul>
                        ...
                        <li className="tutorials"><a href="#">Tutorials</a></li>
                        <li className="about"><a className="active" href="#">About</a></li>
                        <li className="news"><a href="#">faker</a>
                          <ul>
                        ...
                        <If condition={moreItems.length}>
                            <li className={cx('morex')}>
                                <a className={cx('more-btnx')} href="#">
                                    {'Več'}
                                    <img className={cx('subnav')} src={subNav} />
                                </a>
                                <ul className={cx('hiddenx')}>
                                    {
                                        moreItems.map((mi, idx) => {
                                            return (
                                                <li key={`more_${idx}`}><a href={ti.link}>{ti.title}</a></li>
                                            );
                                        })
                                    }
                                </ul>
